      ...
      children: [
              ...
              children: [
                {
                  ...
                  children: [
                    {
                      componentName: 'Text',
                      props: { content: 'xs:24 sm:12 md:8 lg:6' }
                    }
                  ]
                }
              ]
        ...
        // UI 组件演示
        {
          ...
          children: [
            {
              componentName: 'Title',
              props: { level: 2, content: '这是 H2 标题' }
            },
            {
              componentName: 'Title',
              props: { level: 3, content: '这是 H3 标题' }
            },
            {
              componentName: 'Space',
              props: { wrap: true },
              children: [
                ...
                {
                  componentName: 'Text',
                  props: { content: 'Primary', type: 'primary' }
                },
                {
                  componentName: 'Text',
                  props: { content: 'Success', type: 'success' }
                },
                {
                  componentName: 'Text',
                  props: { content: 'Warning', type: 'warning' }
                },
                {
                  componentName: 'Text',
                  props: { content: 'Danger', type: 'danger' }
                },
                {
                  componentName: 'Text',
                  props: { content: 'Info', type: 'info' }
                }
              ]
            }
          ]
          ...
          children: [
            {
              ...
              children: [
                ...
                {
                  componentName: 'Tag',
                  props: { content: 'Round', type: 'primary', round: true }
                }
              ]
            }
          ]
          ...
          children: [
            {
              ...
              children: [
                ...
                {
                  componentName: 'Progress',
                  props: { percentage: 70, status: 'warning' }
                },
                {
                  componentName: 'Progress',
                  props: { percentage: 30, status: 'exception' }
                }
              ]
            }
          ]
