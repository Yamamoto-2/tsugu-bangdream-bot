...
export  function drawDifficulityList(song: Song, imageHeight: number = 80, spacing: number = 10): Canvas {
    ...
    return canvas
    function drawDifficulity(difficultyType: number, playLevel: number, imageHeight: number = 80) {
